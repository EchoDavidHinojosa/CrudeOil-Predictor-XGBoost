...
# Cargar datos
precio_nuevo = pd.read_csv('../../Datos/WTIPredecir27_06.csv', parse_dates=['fecha'])
sp500=pd.read_csv('../../Datos/S&P 500Predecir27_06.csv', parse_dates=['Date'])
...
dolar = pd.read_csv('../../Datos/DollarPredecir27_06.csv', parse_dates=['fecha'])

dolar.rename(columns={'Date': 'fecha', 'Price': 'precioDolar', 'Open': 'OpenDolar','High':'HighDolar','Low':'LowDolar','Change':'ChangeDolar'}, inplace=True)
dolar['fecha'] = dolar['fecha'].dt.normalize()

empresa_Petroleo = pd.read_csv('../../Datos/EPPredecir27_06.csv', parse_dates=['fecha'])
...
X_nuevo = df_nuevo.drop(columns=['fecha','PrecioEnteroSP', 'Vol.EP','precio_objetivo','precioDolar', 'HighDolar','LowDolar','OpenDolar','Open','OpenD','PriceD','precioSp','OpenSp','HighSp','HighD','LowSp','LowD',
                     'Vol.SP','PriceEP','OpenEP','HighEP','LowEP','Vol_WTI'])
